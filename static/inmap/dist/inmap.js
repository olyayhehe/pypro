                ...
                for (var _i2 = 0; _i2 < data.length; _i2++) {
                    ...
                    for (var j = 0; j < labelPixels.length; j++) {
                        ...
                        if (_geometry.type == 'MultiPolygon') {
                            ...
                            if (bestCell && _item.name && this._getMaxWidth(_pixels2[j]) > width) {
                                this._ctx.fillText(_item.name, bestCell.x - width / 2, bestCell.y);
                            }
                        }
...
var HeatOverlay = function (_CanvasOverlay) {
    ...
    _createClass(HeatOverlay, [{
        ...
        value: function refresh() {
            ...
            var img = ctx.getImageData(0, 0, mapSize.width, mapSize.height);
...
var ImgOverlay = function (_Parameter) {
    ...
    _createClass(ImgOverlay, [{
        ...
        key: '_setDrawStyle',
        value: function _setDrawStyle(item, i) {
            var normal = this._styleConfig.normal;
            var result = (0, _Util.merge)({}, normal);
            var count = parseFloat(item.count);
        ...
        value: function _loopDraw(ctx, pixels) {
            ...
            var _loop = function _loop(i, len) {
                var item = pixels[i];
                var pixel = item.geometry.pixel;
                var style = _this3._setDrawStyle(item, i);
        ...
        value: function _render() {
            ...
            list.forEach(function (val, index) {
                ...
                if (val.text) {
                    ...
                    text = _this._opts.formatter(val.start, val.end, index, val);
                } else {
...
var $export = __webpack_require__(0);
var $re = __webpack_require__(195)(/[\\^$*+?.()|[\]{}]/g, '\\$&');
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(12)(proto, TO_PRIMITIVE, __webpack_require__(193));
